    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-8">
          <h1 className="text-3xl font-bold text-gray-900">🔧 Entwickler Profil</h1>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <form onSubmit={handleSaveProfile} className="space-y-4">
              ...
              <button
                ...
                className="w-full py-2 px-4 bg-purple-600 hover:bg-purple-700 disabled:bg-purple-400 text-white font-semibold rounded-lg transition-colors"
              >
