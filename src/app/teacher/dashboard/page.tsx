    ...
    try {
      ...
      const newLobby: Omit<Lobby, 'id'> = {
        ...
        submodules: {
          ...
          controlling: {
            kalkulation: false,
            deckungsbeitrag: false,
            breakEven: false,
            kennzahlen: false,
          },
          finanzen: {
            buchungssaetze: false,
            belegpruefung: false,
            bilanzierung: false,
          },
          kaufvertragsstoerungen: {
            lieferverzug: false,
            schlechtleistung: false,
            zahlungsverzug: false,
            mahnungen: false,
          },
        },
        difficulty: 'easy',
        ...
        marketSettings: {
          ...
          teacherCanTriggerEvents: true,
        },
        programsEnabled: {
          mail: true,
          textverarbeitung: false,
          lager: true,
          produktkatalog: true,
          buchung: true,
          banking: true,
